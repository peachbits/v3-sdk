...
describe('Position', () => {
    ...
    describe('#amount0', () => {
        it('is correct for price above', () => {
            ...
            }).amount0.quotient.toString()).toEqual('49949961958869841');
        });
        it('is correct for price below', () => {
            ...
            }).amount0.quotient.toString()).toEqual('0');
        });
        it('is correct for in-range position', () => {
            expect(new Position({
                ...
                tickLower: nearestUsableTick(POOL_TICK_CURRENT, TICK_SPACING) - TICK_SPACING * 2,
                tickUpper: nearestUsableTick(POOL_TICK_CURRENT, TICK_SPACING) + TICK_SPACING * 2
            }).amount0.quotient.toString()).toEqual('120054069145287995769396');
        });
    });
    describe('#amount1', () => {
        it('is correct for price above', () => {
            expect(new Position({
                ...
                tickLower: nearestUsableTick(POOL_TICK_CURRENT, TICK_SPACING) + TICK_SPACING,
                tickUpper: nearestUsableTick(POOL_TICK_CURRENT, TICK_SPACING) + TICK_SPACING * 2
            }).amount1.quotient.toString()).toEqual('0');
        });
        it('is correct for price below', () => {
            expect(new Position({
                pool: DAI_USDC_POOL,
                ...
                tickLower: nearestUsableTick(POOL_TICK_CURRENT, TICK_SPACING) - TICK_SPACING * 2,
                tickUpper: nearestUsableTick(POOL_TICK_CURRENT, TICK_SPACING) - TICK_SPACING
            }).amount1.quotient.toString()).toEqual('49970077052');
        });
        it('is correct for in-range position', () => {
            expect(new Position({
                pool: DAI_USDC_POOL,
                ...
                tickLower: nearestUsableTick(POOL_TICK_CURRENT, TICK_SPACING) - TICK_SPACING * 2,
                tickUpper: nearestUsableTick(POOL_TICK_CURRENT, TICK_SPACING) + TICK_SPACING * 2
            }).amount1.quotient.toString()).toEqual('79831926242');
        });
    });
    describe('#mintAmountsWithSlippage', () => {
        ...
        describe('5% slippage tolerance', () => {
            ...
            it('is correct for pool at max price', () => {
                const position = new Position({
                    pool: new Pool(DAI, USDC, FeeAmount.LOW, JSBI.subtract(TickMath.MAX_SQRT_RATIO, JSBI.BigInt(1)), 0, TickMath.MAX_TICK - 1, []),
                    liquidity: 100e18,
                    tickLower: nearestUsableTick(POOL_TICK_CURRENT, TICK_SPACING) + TICK_SPACING,
                    tickUpper: nearestUsableTick(POOL_TICK_CURRENT, TICK_SPACING) + TICK_SPACING * 2
                });
