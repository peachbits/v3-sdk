...
describe('#encodeRouteToPath', () => {
    ...
    it('packs them correctly for multihop exact input', () => {
        expect(encodeRouteToPath(route_0_1_2, false)).toEqual('0x0000000000000000000000000000000000000001000bb800000000000000000000000000000000000000020001f40000000000000000000000000000000000000003');
    });
    it('packs them correctly for multihop exact output', () => {
        expect(encodeRouteToPath(route_0_1_2, true)).toEqual('0x00000000000000000000000000000000000000030001f40000000000000000000000000000000000000002000bb80000000000000000000000000000000000000001');
    });
    it('wraps ether input for exact input single hop', () => {
        expect(encodeRouteToPath(route_weth_0, false)).toEqual('0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2000bb80000000000000000000000000000000000000001');
    });
    it('wraps ether input for exact output single hop', () => {
        expect(encodeRouteToPath(route_weth_0, true)).toEqual('0x0000000000000000000000000000000000000001000bb8c02aaa39b223fe8d0a0e5c4f27ead9083c756cc2');
    });
    it('wraps ether input for exact input multihop', () => {
        expect(encodeRouteToPath(route_weth_0_1, false)).toEqual('0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2000bb80000000000000000000000000000000000000001000bb80000000000000000000000000000000000000002');
    });
    it('wraps ether input for exact output multihop', () => {
        expect(encodeRouteToPath(route_weth_0_1, true)).toEqual('0x0000000000000000000000000000000000000002000bb80000000000000000000000000000000000000001000bb8c02aaa39b223fe8d0a0e5c4f27ead9083c756cc2');
    });
    it('wraps ether output for exact input single hop', () => {
        expect(encodeRouteToPath(route_0_weth, false)).toEqual('0x0000000000000000000000000000000000000001000bb8c02aaa39b223fe8d0a0e5c4f27ead9083c756cc2');
    });
    it('wraps ether output for exact output single hop', () => {
        expect(encodeRouteToPath(route_0_weth, true)).toEqual('0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2000bb80000000000000000000000000000000000000001');
    });
    it('wraps ether output for exact input multihop', () => {
        expect(encodeRouteToPath(route_0_1_weth, false)).toEqual('0x0000000000000000000000000000000000000001000bb80000000000000000000000000000000000000002000bb8c02aaa39b223fe8d0a0e5c4f27ead9083c756cc2');
    });
    it('wraps ether output for exact output multihop', () => {
        expect(encodeRouteToPath(route_0_1_weth, true)).toEqual('0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2000bb80000000000000000000000000000000000000002000bb80000000000000000000000000000000000000001');
    });
});
//# sourceMappingURL=encodeRouteToPath.test.js.map