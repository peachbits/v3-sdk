...
describe('PositionLibrary', () => {
    describe('#getTokensOwed', () => {
        ...
        it('non-0', () => {
            const [tokensOwed0, tokensOwed1] = PositionLibrary.getTokensOwed(ZERO, ZERO, JSBI.BigInt(1), JSBI.exponentiate(JSBI.BigInt(2), JSBI.BigInt(128)), JSBI.exponentiate(JSBI.BigInt(2), JSBI.BigInt(128)));
